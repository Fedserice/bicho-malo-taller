...
function Aurora({ colorStops = ["#e35f27", "#f1c7a5", "#dedbd2"], amplitude = 1, blend = 0.5, speed = 1 }) {
  ...
  useEffect(() => {
    ...
    let animationId = requestAnimationFrame(function render(time) {
      animationId = requestAnimationFrame(render);
      const props = propsRef.current;
      program.uniforms.uTime.value = time * props.speed * 0.001;
